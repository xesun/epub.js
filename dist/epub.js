 ...
 */
  ...
  */
	afterDisplayed(view) {
		...
		view.on(_constants.EVENTS.VIEWS.MARK_CLICKED, (cfiRange, data) => this.triggerMarkEvent(cfiRange, data, view));
...
var _continuous = __webpack_require__(69);
	...
	loadNavigation(opf) {
		...
		if (toc) {
			return new Promise((resolve, reject) => {
				...
				if (opf.pageList) {
					this.pageList = new _pagelist2.default(opf.pageList); // TODO: handle page lists from Manifest
				}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* From https://github.com/webcomponents/URL/blob/master/url.js
